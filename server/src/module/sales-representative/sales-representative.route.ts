...
salesRepresentativeRouter.get('/sales-representatives', isAuthenticated, validateQuery(salesRepresentativeQuerySchema), salesRepresentativeController.getSalesRepresentatives);
