...
import { createRegionSchema, updateRegionSchema, regionParamsSchema } from './region.validator.js';
...
regionRouter.get('/regions', isAuthenticated, validateQuery(paginationQuerySchema), regionController.getAllRegions);
